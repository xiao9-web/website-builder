...
Step 2: Search for owner
  ...
  → Search .claude/agents/*.md and canonical/skills/meta-theory/ for declared "Own" boundaries
...
### Execution
1. Read agent definitions: `Glob .claude/agents/*.md`
2. Dispatch quality audit via **meta-prism** (capability = "code quality review, AI-slop detection, Five Criteria + Four Death Patterns audit"):
   ...
   Files: Glob .claude/agents/*.md + canonical/skills/meta-theory/references/meta-theory.md.
